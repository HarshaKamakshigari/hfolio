...
//   return (
//     <main className="min-h-screen flex flex-col items-center justify-between p-8 bg-black text-white font-mono">
//       {/* Top number */}
//       <div className="text-white/80 text-lg mt-4 tracking-widest">21</div>

//       {/* Main content */}
//       <div className="flex flex-col md:flex-row items-center justify-center gap-10 flex-1">
//         {/* Left image (temporary placeholder) */}
...
// import Image from "next/image";
// import Footer from "../components/Footer";
// import CommandMenu from "../components/CommandMenu"; // Add this import
...
//   return (
//     <>
//       {/* ⌘K Command Menu Hint - Clickable */}
//       <button
//         onClick={() => setIsCommandOpen(true)}
//         className="fixed top-4 right-4 z-40 text-xs text-gray-500 bg-black/50 hover:bg-black/70 px-3 py-1 rounded-full backdrop-blur-sm border border-white/10 hover:border-white/20 transition-all duration-200 flex items-center gap-1"
//         aria-label="Open command menu (⌘K)"
//       >
//         <kbd className="text-red-400 font-mono">⌘K</kbd>
//       </button>

//       <main className="min-h-screen flex flex-col items-center justify-between p-8 bg-black text-white font-mono relative">
//         {/* Command Menu - Controlled by parent state */}
